...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
       ...
       <div class="nav-bar justify-content-end">
            <ul class="nav justify-content-end">
                ...
                <div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                         <div class="modal-content">
                            ...
                            <h5 class="modal-title" id="Modal">Create an Account</h5>
               ...
               <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                ...
                <div class="form-group">
                     ...
                     <button type="submit" class="btn2 btn-primary">Register</button>
                     <button type="submit" class="btn3 btn-primary" data-toggle="modal" data-target="#login">Already have an account</button>
                </form>
                    </div>
                    </div>
                    </div>
        ...
        <li class="nav-item1">
                 <button type="button" class="btn4 btn-secondary" data-toggle="modal" data-target="#login">Login</button>
                  
                 <div class="modal fade" id="login" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                         <div class="modal-content">
                            <div class="modal-header">
                            <h5 class="modal-title" id="login">Login you Account</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                         </button>
                            </div>
        ...
        <div class="image">
            <img src="{{ URL('image/vector.png') }}" alt="" height="450">
        </div>
        <div class="text">
            <h1 class="head1"> Appoint an consultation<br> with us.</h1>
            <p class="text1">
            An online hospital that connects you with your doctor 
